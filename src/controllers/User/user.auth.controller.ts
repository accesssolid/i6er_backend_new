...
*/
    @Security('Bearer')
    @Put("/profile")
    public async updateUserProfile(@FormField() display_name?: string, @FormField() first_name?: string, @FormField() last_name?: string, @FormField() dob?: number, @FormField() blood_group?: string, @UploadedFile() profile_pic?: Express.Multer.File): Promise<ApiResponse> {
        const body = { display_name, first_name, last_name, dob, blood_group }
