...
const SUBSCRIPTION_PLAN_STATUS = {
  ACTIVE: 1,
  DELETED: 2,
  DEACTIVATED: 3,
};
...
export {
  STRIPE_CREDENTIAL, DB, APP, ROLE, REDIS_CREDENTIAL, LOGS, USER_STATUS, AWS_CREDENTIAL,
  EMAIL_CREDENTIAL, SMS_CREDENTIAL, INFO_TYPE, SUBSCRIPTION_PLAN_STATUS, 
